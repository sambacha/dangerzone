...
`GET https://api.backbonecabal.com/v1/jsonrpc/:network/eth_getTransactionReceipt?params=:paramsJSONArray`
...
```bash
// HTTP GET
curl -G https://api.backbonecabal.com/v1/jsonrpc/mainnet/eth_getTransactionReceipt --data-urlencode 'params=["0xbb3a336e3f823ec18197f1e13ee875700f08f03e2cab75f0d0b118dabb44cba0"]'
...
It also returns _either_: - `root` : 32 bytes of post-transaction stateroot (pre Byzantium) - `status`: either 1 (success) or 0 (failure)
