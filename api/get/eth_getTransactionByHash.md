...
`GET https://api.backbonecabal.com/v1/jsonrpc/:network/eth_getTransactionByHash?params=:paramsJSONArray`
...
```bash
// HTTP GET
curl -G https://api.backbonecabal.com/v1/jsonrpc/mainnet/eth_getTransactionByHash --data-urlencode 'params=["0xbb3a336e3f823ec18197f1e13ee875700f08f03e2cab75f0d0b118dabb44cba0"]'
