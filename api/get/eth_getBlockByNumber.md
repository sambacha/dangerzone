...
`GET https://api.backbonecabal.com/v1/jsonrpc/:network/eth_getBlockByNumber?params=:paramsJSONArray`
...
```bash
// HTTP GET
curl -G https://api.backbonecabal.com/v1/jsonrpc/mainnet/eth_getBlockByNumber --data-urlencode 'params=["0x5BAD55",false]'
