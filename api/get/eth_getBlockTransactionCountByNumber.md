...
`GET https://api.backbonecabal.com/v1/jsonrpc/:network/eth_getBlockTransactionCountByNumber?params=:paramsJSONArray`
...
```bash
// HTTP GET
curl -G https://api.backbonecabal.com/v1/jsonrpc/mainnet/eth_getBlockTransactionCountByNumber --data-urlencode 'params=["latest"]'
